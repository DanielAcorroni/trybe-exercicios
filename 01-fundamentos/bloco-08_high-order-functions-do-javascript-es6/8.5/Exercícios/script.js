...
//02
const sum = (...rest) => {
    const result = rest.reduce((acc, number) => acc + number, 0);
    return result;
};
...
const swap = (numbers) => {
    const [ firstElement, secondElement, thirdElement ] = numbers;
    const returnVariable = [thirdElement, secondElement, firstElement];
    return returnVariable;
};
